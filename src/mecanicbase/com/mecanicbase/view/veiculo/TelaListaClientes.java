...
import mecanicbase.com.mecanicbase.view.cliente.TelaCliente;
import mecanicbase.com.mecanicbase.view.veiculo.TelaVeiculo;
...
public class TelaListaClientes extends javax.swing.JFrame {
    ...
    public TelaListaClientes() {
        ...
        listarClientes();
        this.telaVeiculo = null;
    }
    
    
    public TelaListaClientes(TelaVeiculo telaVeiculo){
        initComponents();
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        ...
        String nome = tabelaCliente.getValueAt(linha, 1).toString();

        // envia para outra tela
        telaVeiculo.setClienteSelecionado(id, nome);
